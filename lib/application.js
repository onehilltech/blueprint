...
module.exports = ApplicationModule.extend ({
  ...
  configure () {
    ...
    return ensureDir (this.tempPath).then (() => {
      ...
      */
      ...
      return this._appInit.signalAndWait ();
    });
  },
  ...
  start () {
    ...
    return this._server.listen ().then (() => {
      ...
      return this._appStart.signalAndWait ();
    });
  },
  ...
  restart () {
    ...
    this._messaging.emit ('blueprint.app.restart', this);
    return this._appRestart.signalAndWait ();
  },
