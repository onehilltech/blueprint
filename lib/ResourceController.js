...
ResourceController.prototype.getAll = function (opts) {
  ...
  var onUpdateFilter = opts.onUpdateFilter || __onUpdateFilter;
  var onPostExecute = opts.onPostExecute || __onPostExecute;
  var onValidate = opts.onValidate || __onValidate;
  var self = this;
...
ResourceController.prototype.create = function (opts) {
  ...
  var onPrepareDocument = opts.onPrepareDocument || __onUpdateFilter;
  var onPostExecute = opts.onPostExecute || __onPostExecute;
  var onValidate = opts.onValidate || __onValidate;
  var self = this;
