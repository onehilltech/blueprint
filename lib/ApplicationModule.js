...
ApplicationModule.prototype.init = function (callback) {
  ...
  async.waterfall ([
    ...
    function (module, callback) {
      module.listenerManager = new ListenerManager (Framework ().messaging);
    ...
    function (module, callback) {
      module.policyManager = new PolicyManager ();
    ...
    function (module, callback) {
      module.modelManager = new ModelManager ();
    ...
    function (module, callback) {
      module.controllerManager = new ControllerManager ();
    ...
    function (module, callback) {
      module.routerManager = new RouterManager (module.controllers);
      var rcPath = path.join (module.appPath, 'routers');

      module.routerManager.load (rcPath, function (err) {
        if (err && err.code === 'ENOENT') err = null;
        return callback (err, module);
      });
    }
