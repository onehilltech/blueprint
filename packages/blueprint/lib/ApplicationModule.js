 ...
 * xpression.Application() has been called for the top-level project.
 *
 * @param appPath
 * @constructor
 */
...
ApplicationModule.prototype.__defineGetter__ ('models', function () {
  ...
  messaging.emit ('app.models.loading', this);
  this._models = Loader.loadModels (path.join (this.appPath, 'models'));
  messaging.emit ('app.models.loaded', this);
...
ApplicationModule.prototype.__defineGetter__ ('controllers', function () {
  ...
  messaging.emit ('app.controllers.loading', this);
  this._controllers = Loader.loadControllers (path.join (this.appPath, 'controllers'));
  messaging.emit ('app.controllers.loaded', this);
...
ApplicationModule.prototype.__defineGetter__ ('routers', function () {
  ...
  messaging.emit ('app.routers.loading', this);
  this._routers = Loader.loadRouters (routerPath, this.controllers)
  messaging.emit ('app.routers.loaded', this);
...
ApplicationModule.prototype.__defineGetter__ ('listeners', function () {
  ...
  messaging.emit ('app.listeners.loading', this);
  this._listeners = Loader.loadListeners (listenersPath, messaging);
  messaging.emit ('app.listeners.loaded', this);
