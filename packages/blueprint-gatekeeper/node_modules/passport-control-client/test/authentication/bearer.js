...
var common      = require ('passport-control-common'),
    User        = common.models.User,
    Client      = common.models.oauth2.Client,
    AccessToken = common.models.oauth2.AccessToken;

describe ('oauth2 strategy', function () {
  var bearer = require ('../..').auth.bearer;
  var server;
